...
<jsp:include page="../inc/Header.jsp" flush="false">
	...
	<div id="articlecontent">
		...
		<div id="comment">안녕하세요. 비에이블스터디카페입니다.</div>
		...
		<p>
		비에이블스터디카페는 넓은 공간에서 여러 회원님들이 함께 공동으로 이용하실 수 있는 자유로운 분위기의 캠퍼스존과<br/> 
		단체회의, 그룹스터디 등 어떠한 모임이 가능한 스터디룸 그리고 잔잔한 음악이 나오고, 간단한 다과, 조용한 대화가 허용되는 휴식공간을 마련했습니다.
		</p>
		<p>
