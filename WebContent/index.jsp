...
<head>
  ...
  <link rel="stylesheet" href="./css/style.v2.css?<%=DateUtil.getCurrentDateTime() %>" type="text/css" media="all">
  <style>
body {background-image:url('./images/main/bg_00.png');background-size:cover;}
    ...
    <div class="footer">
		<table>
			<tr>
				...
				<th> 주소</th>
				<td class='b'> 서울시 강서구 양천로 583 A동 2210호</td>
			</tr>
			<tr>
				<th>대표자</th>
				<td class='f'>전보익</td>
				<th>사업자 등록번호</th>
				<td class='b biz'>641-81-01148</td>
			</tr>
			<tr>
