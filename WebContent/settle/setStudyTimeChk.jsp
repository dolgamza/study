...
<%
	...
	String paramSeqNo	= StrUtil.nvl(request.getParameter("paramSeqNo"));
	String paramCardNo	= StrUtil.nvl(request.getParameter("paramCardNo"));
	String paramRfid	= StrUtil.nvl(request.getParameter("paramRfid"));
	String product		= StrUtil.nvl(request.getParameter("product"));
	String seat			= StrUtil.nvl(request.getParameter("seat"));
	
	String strStartYmd	= StrUtil.nvl(request.getParameter("strStartYmd"));
	String strev_mi		= StrUtil.nvl(request.getParameter("strev_mi"));
	String strev_ss		= StrUtil.nvl(request.getParameter("strev_ss"));
	String edrev_mi		= StrUtil.nvl(request.getParameter("edrev_mi"));
	String edrev_ss		= StrUtil.nvl(request.getParameter("edrev_ss"));
