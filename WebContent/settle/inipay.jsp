...
<%
	...
	String centerNo 	= request.getParameter("centerNo");	//센터 번호
	String chkRoom 		= request.getParameter("chkRoom");	//
	String chkSeat		= request.getParameter("chkSeat");
  ...
  *** 휴대폰 전용 필드 ***
  P_HPP_METHOD      상품컨텐츠구분 char(1) 휴대폰(HPP) 결제수단 사용시 필수 / 1=컨텐츠, 2=실물
	...
	************************************************************************************-->
	...
	<h3>INIpay Mobile WEB</h3>
	<hr>
	<table border="0" width="360"> 
	<tr> 
		<td><p>결제수단선택</p></td> 
		<td>
			<input type="text" name="P_GOPAYMETHOD" value="card">
		</td> 
	</tr> 
	<tr> 
	...
	<tr> 
		<td><p>상품명(P_GOODS)</p></td> <td><input type="text" name="P_GOODS" value="<%=productNm %>"></td> 
	</tr> 

	<tr> 
		<td><p>금액(P_AMT)</p></td> <td><input type="text" name="P_AMT" value="<%=productAmt %>"></td> 
	</tr> 
